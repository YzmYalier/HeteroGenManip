...
# 'task_name' must be {task}_stage_{stage_index}, e.g. Hang_Coat_stage_1
...
$ISAAC_PATH torchrun --nproc_per_node=2 --nnodes=1 train_ddp.py --config-name=${config_name}.yaml \
