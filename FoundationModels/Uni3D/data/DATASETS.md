...
1. Please download the data from this [repository](https://huggingface.co/BAAI/FoundationModels/Uni3D/blob/main/data/test_datasets.zip), which contains datasets for Objaverse-LVIS, ModelNet40, and ScanObjectNN.
